...
if __name__ == "__main__":
    ...
    for batch_size in batch_size_list:
        for lr in lr_list:
            ...
            model_ft.load_state_dict(torch.load('/home/recep/dataprocessing/model/Dronet_new.pth'))   
            #model_ft.load_state_dict(torch.load('/home/recep/dataprocessing/model/16_0.001_2_loss_0.0101_PG.pth'))
