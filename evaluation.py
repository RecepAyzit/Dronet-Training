...
if __name__ == "__main__":
    ...
    #model.load_state_dict(torch.load('/home/recep/dataprocessing/model/16_0.001_2_loss_0.0101_PG.pth'))
    
    #model.load_state_dict(torch.load('/home/recep/dataprocessing/model/16_0.001_27_loss_0.0407_PG.pth')) ### İYİ SONUÇ
    model.load_state_dict(torch.load('/home/recep/dataprocessing/model/16_0.001_49_loss_0.0403_PG.pth'))  ### İYİ SONUÇ
